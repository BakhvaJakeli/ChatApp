...
class ReceiverChatBubbleVIew: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        let mainTextBubble = UIBezierPath(roundedRect: CGRect(x: 32, y: frame.minY, width: textLabel.frame.width, height: textLabel.frame.height), cornerRadius: 25)
